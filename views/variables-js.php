...
<div class="container is-flex">
	...
	<div class="tile is-parent">
		<article class="tile is-child">
			...
			<p class="content">Básciamente es un contenedor para guardar en memoria pedazos de información</p>

			<h3>Declaración de Variables</h3>
			<p class="content">Hay tres tipos de declaración(creación) de variables en JavaScript.
				<ul>
					<li> <code>var</code> declara la variable, inicializandola opcionalmente a un valor</li>
					
					<li><code><a href="#let">let</a></code> declara una variable local a nivel de bloque, inicializandola opcionalmente a un valor</li>
					
					<li><code><a href="#const">const</a></code> declara una variable local sólo de lectura a nivel de bloque, llamada constante.</li>
				</ul>
			</p>
		</article>
	</div>
	...
	<div class="tile is-parent">
		...
		<div class="tile is-parent">
			<article class="tile is-child">
				...
				<p>El alcance determina la accesibilidad (visibilidad) de una variable. Hay dos tipos de alcance: <em>Local</em> y <em>Global</em></p>
