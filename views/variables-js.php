...
<H1>VARIABLES</H1>
	<p>Como casi en todos, sino en todos los lenguajes de programación, las variables son básicamente cajas abstractas donde almacenar todo tipo de información.</p>
    <hr>
  ...
  <p> <code>var</code><br>
  declara la variable, inicializandola opcionalmente a un valor</p>
  
	<p><code><a href="#let">let</a></code><br>
  declara una variable local a nivel de bloque, inicializandola opcionalmente a un valor</p>
  
	<p><code><a href="#const">const</a></code><br>
  declara una variable local sólo de lectura a nivel de bloque, llamada constante.</p>
  
  <p>Las <em>variables</em> se usan como nombres simbólicos para los valores dentro de tu aplicación. Estos nombres son llamados <em>identificadores</em>. Todas las variables deben ser identificados con un nombre único.</p>
	<p>Reglas generales para la construcción de nombres para variables:</p>
	<p>
		<ul>
