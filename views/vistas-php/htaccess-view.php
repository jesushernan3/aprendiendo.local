	...
	<H1>HTACCESS</H1>
		...
		<div class="tile is-parent">
			<article class="tile is-child">
				...
				<p>El archivo <em>.htaccess</em> es una herramienta poderosa para modificar su configuración de Apache en un nivel por dominio e incluso por nivel de directorio. Muchos sistemas de administración de contenido dependen de archivos .htaccess para configurar su sitio. También puede crear su propio archivo .htaccess manualmente.</p>
